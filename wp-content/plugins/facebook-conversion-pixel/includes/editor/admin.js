...
jQuery(document).ready(function($){
	...
	if ( typeof( fcaPcPremiumData ) === 'undefined' ) {
		$(  '.fca-pc-user_parameters, ' +
			...
			'.fca-pc-woo_feed, ' +
			'.fca-pc-woo_integration, ' +
			'.fca-pc-woo_extra_params, ' +
			'.fca-pc-woo_delay, ' +
			'.fca-pc-edd_feed, ' +
			'.fca-pc-edd_integration, ' +
			'.fca-pc-edd_extra_params, ' +
			'.fca-pc-edd_delay, ' +
			'.fca-pc-advanced_matching, ' +
			'.fca-pc-amp_integration'			).prop('checked', false).prop('disabled', true).closest('tr').addClass('fca-pc-integration-disabled')
		...
		//PREMIUM BUILDS
		if ( fcaPcAdminData.woo_active == false || fcaPcPremiumData.package === 'Personal' ) {
			$( '.fca-pc-woo_feed, ' +
				'.fca-pc-woo_integration, ' +
				'.fca-pc-woo_extra_params, ' +
				'.fca-pc-woo_delay' ).prop('checked', false).prop('disabled', true).closest('tr').addClass('fca-pc-integration-disabled')
		} 
		if ( fcaPcAdminData.edd_active == false || fcaPcPremiumData.package === 'Personal' ) {
			$(	'.fca-pc-edd_feed, ' +
				'.fca-pc-edd_integration, ' +
				'.fca-pc-edd_extra_params, ' +
